                ...
                <div class="row g-4 mb-4">
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="border rounded">
                                    <a href="#">
                                        <img src="/images/product/${product.image}" class="img-fluid rounded w-100" alt="${product.name}" />
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="col-lg-4">
                        <div class="border rounded p-4">
                            ...
                            <c:forEach var="relatedProduct" items="${products}" varStatus="status">
                            <c:if test="${relatedProduct.product_id != product.product_id}">
                                <div class="d-flex mb-3">
                                    <a href="/homepage/product/${relatedProduct.product_id}">
                                        <img src="/images/product/${relatedProduct.image}" class="img-fluid rounded me-3"
                                             style="width: 80px; height: 80px; object-fit: cover;" alt="${relatedProduct.name}">
                                    </a>
                                    <div>
                                        <a href="/homepage/product/${relatedProduct.product_id}" class="text-dark">
