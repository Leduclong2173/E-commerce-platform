                        ...
                        <div class="mt-5">
                            <div class="row">
                                <div class="col-md6 col-12 mx-auto">
                                    <h3>Delete Category with id = ${id}</h3>
                                    <hr />
                                    <div class="alert alert-danger">Are you sure to delete this Category ?</div>
                                    <form:form method="post" action="/admin/category/delete" modelAttribute="deleteCategory">
                                        <div class="mb-3" style="display: none">
                                            <label for="Id" class="form-label">Id</label>
                                            <form:input value="${id}" type="text" class="form-control" id="Id" path="category_id" />
                                        </div>
