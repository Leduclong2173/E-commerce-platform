                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="/admin/shop/manageproduct/${product.shop.shop_id}">Products</a></li>
                        ...
                        <div class="container mt-5">
                            <div class="row">
                                <div class="col-12 mx-auto">
                                    ...
                                    <a href="/admin/shop/manageproduct/${product.shop.shop_id}" class="btn btn-success mt-3">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
